	...
	<div class="controls">
		<div class="slider-wrap">
			<div class="slider-header">
				<span class="slider-title">Reverse Generative Process</span>
			...
			/>
			<div class="labels">
				<span><span class="math">x<sub>T</sub></span> (Sampled Noise)</span>
				<span><span class="math">x<sub>0</sub></span> (Reconstructed Manifold)</span>
			</div>
		</div>
	</div>

	<p class="caption">
		<strong>Figure 2:</strong> The reverse generative process. Starting from sampled isotropic
		Gaussian noise <span class="math">p(x<sub>T</sub>)</span>, a neural network iteratively predicts
		and removes noise, transporting the points back to the structured data manifold (dashed line) at
		<span class="math">t = 0</span>.
	</p>
</div>
